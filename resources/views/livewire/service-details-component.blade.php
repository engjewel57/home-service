                                    ...
                                    <div class="panel-body">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td style="border-top: none;"><span>TK: </span> {{$service->price}}</td>
                                            </tr>
                                            <tr>
                                                <td>Quntity</td>
                                                <td>1</td>
                                            ...
                                            @endphp
                                            @if($service->discount)
                                                @if($service->discount_typr =='fixed')
                                                    <tr>
                                                        <td>Discount</td>
                                            ...
                                            <tr>
                                                <td>Total</td>
                                                <td><span>TK:</span> {{$total}}</td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="panel-footer">
                                        <form>
                                            <div class="content-btn"><a href="{{route('home.servicep')}}" class="btn btn-primary">Book Now</a>
                                    ...
                                    <div class="col-md-12 col-sm-6 col-xs-12 bg-dark color-white padding-top-mini"
                                        ...
                                        <a href="{{route('home.service_details',['service_slug'=>$r_service->slug])}}">
                                            ...
                                            <div class="info-gallery">
                                                ...
                                                <div class="price"><p>৳&nbsp;</p><b></b>{{$r_service->price}}</div>
